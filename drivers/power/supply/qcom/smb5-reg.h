...
#define USBIN_ICL_OVERRIDE_BIT			BIT(2)
#define USBIN_IN_COLLAPSE_FG_SEL		GENMASK(1, 0)
#define USBIN_IN_COLLAPSE_FG_30MS			2
#define USBIN_IN_COLLAPSE_FG_30US			3
...
#define USBIN_AICL_PERIODIC_RERUN_EN_BIT	BIT(8)
